...
export default function AdminSettings() {
  ...
  const siteInfo = [
    ...
    { label: "Email", value: "digital@w3appdevelopers.com", icon: Mail },
    {
      label: "Address",
      value: "Mullamparappu, Erode, Tamil Nadu, India",
      icon: MapPin,
    },
  ];
  ...
  return (
    <div>
      ...
      <p className="text-slate-500 mb-8">
        Site configuration and environment overview
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-none shadow-sm">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-slate-400 mt-4">
              Secrets are managed via Replit Secrets panel. Never expose these
              in code.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-sm lg:col-span-2">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-slate-400 mt-4">
              To update these values, modify them in Replit Secrets. Changes
