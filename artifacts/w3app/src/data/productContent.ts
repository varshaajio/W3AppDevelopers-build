...
export const productContentMap: Record<string, ProductContent> = {
  ...
  "field-service-management": {
    ...
    headline: "What is Field Service Management Software?",
    description: [
      "Field Service Management (FSM) Software is a comprehensive solution that helps businesses efficiently manage their field operations, including scheduling, dispatching, and tracking field technicians and service teams.",
      "It bridges the gap between the office and the field by providing real-time visibility into job status, technician location, and customer communication — resulting in faster response times and higher customer satisfaction.",
      "From work order creation to invoicing, our FSM platform automates end-to-end field workflows, helping organizations reduce costs and improve service quality.",
    ],
    features: [
    ...
    sections: [
      { heading: "Why Use Field Service Management Software?", body: "FSM software eliminates paperwork, reduces delays, and ensures the right technician reaches the right job at the right time with all the tools and information they need." },
      { heading: "Who Uses FSM Software?", body: "HVAC companies, plumbing services, electrical contractors, IT support firms, telecom companies, property maintenance businesses, and any organization with field-based teams." },
    ],
    whoUses: ["HVAC Companies", "Plumbing Services", "Electrical Contractors", "IT Support Firms", "Telecom Companies", "Property Management"],
    cta: "Get a FSM Demo",
  },

  "ai-seo-agent": {
    slug: "ai-seo-agent",
    headline: "What is an AI SEO Agent?",
    description: [
      "An AI SEO Agent is an intelligent, automated tool that continuously analyzes your website, researches keywords, audits content, and takes data-driven actions to improve your search engine rankings.",
      "Unlike traditional SEO tools that only report data, our AI SEO Agent actively generates optimized content suggestions, fixes on-page issues, monitors competitors, and adapts to algorithm changes in real time.",
      "It puts the power of a full SEO team into an autonomous agent that works around the clock to grow your organic traffic.",
    ],
    features: [
    ...
    sections: [
      { heading: "Why Use an AI SEO Agent?", body: "SEO is time-consuming and constantly evolving. Our AI agent automates repetitive tasks, identifies opportunities faster than manual analysis, and ensures your site stays optimized continuously." },
      { heading: "Who Benefits from AI SEO Agents?", body: "Digital marketing agencies, eCommerce stores, SaaS companies, bloggers, and any business looking to grow organic search traffic without hiring a large SEO team." },
    ],
    whoUses: ["Digital Marketing Agencies", "eCommerce Stores", "SaaS Companies", "Content Publishers", "Local Businesses"],
    cta: "Try the AI SEO Agent",
  },

  "job-portal-development": {
    slug: "job-portal-development",
    headline: "What is a Job Portal?",
    description: [
      "A Job Portal is a feature-rich online platform that connects employers with job seekers, enabling companies to post job openings and candidates to search, apply, and track their applications in one place.",
      "Our custom job portal development includes separate dashboards for employers, candidates, and administrators — with advanced search filters, resume management, and automated email notifications.",
      "We build scalable, SEO-optimized job portals that can handle thousands of listings and users while delivering a smooth, professional experience.",
    ],
    features: [
    ...
    sections: [
      { heading: "Why Build a Custom Job Portal?", body: "A custom job portal gives you full control over branding, features, and data. It can be tailored for niche industries, government recruitment, campus placements, or general hiring." },
      { heading: "Who Uses Job Portals?", body: "Staffing agencies, HR consulting firms, educational institutions for campus placement, government organizations, and enterprises looking for an internal hiring platform." },
    ],
    whoUses: ["Staffing Agencies", "HR Consulting Firms", "Educational Institutions", "Government Organizations", "Enterprises"],
    cta: "Build Your Job Portal",
  },

  "shopping-cart-software": {
    slug: "shopping-cart-software",
    headline: "What is Shopping Cart Software?",
    description: [
      "Shopping Cart Software is the backbone of any eCommerce operation — it manages the entire buying process from product browsing and cart management to secure checkout and order confirmation.",
      "Our shopping cart solutions are built for performance and scalability, supporting multiple payment gateways, discount engines, tax management, and real-time inventory updates.",
      "Whether you're running a single-vendor store or a multi-vendor marketplace, our platform adapts to your business model with a clean UI and robust admin controls.",
    ],
    features: [
      "Product Catalog Management",
    ...
    sections: [
      { heading: "Why Choose Our Shopping Cart Software?", body: "Our platform is optimized for high conversion rates with fast loading, intuitive navigation, and secure checkout flows that reduce cart abandonment and increase sales." },
      { heading: "Who Uses Shopping Cart Software?", body: "Retail businesses, wholesale distributors, fashion brands, electronics stores, food businesses, and any organization looking to sell products or services online." },
    ],
    whoUses: ["Retail Businesses", "Wholesale Distributors", "Fashion Brands", "Electronics Stores", "Food & Beverage Brands"],
    cta: "Get Your Shopping Cart Built",
  },

  "erp-software": {
    slug: "erp-software",
    headline: "What is ERP Software?",
    description: [
      "Enterprise Resource Planning (ERP) Software is an integrated management system that connects all core business processes — finance, procurement, HR, inventory, production, and sales — into a single unified platform.",
      "Our ERP solution gives decision-makers real-time visibility across departments, eliminating data silos and enabling smarter, faster business decisions.",
      "Designed for growing businesses, our ERP platform is modular and scalable — start with the modules you need and expand as your business grows.",
    ],
    features: [
    ...
    sections: [
      { heading: "Why Implement ERP Software?", body: "ERP eliminates redundant data entry, reduces operational errors, improves collaboration between departments, and provides a single source of truth for all business data." },
      { heading: "Who Uses ERP Software?", body: "Manufacturing companies, trading firms, retail chains, construction businesses, healthcare organizations, and any enterprise managing complex multi-department operations." },
    ],
    whoUses: ["Manufacturing Companies", "Trading Firms", "Retail Chains", "Construction Companies", "Healthcare Organizations"],
    cta: "Schedule an ERP Demo",
  },

  "food-delivery-software": {
    slug: "food-delivery-software",
    headline: "What is Food Delivery Software?",
    description: [
      "Food Delivery Software is a complete on-demand platform that connects restaurants with customers and delivery drivers, managing everything from order placement to real-time tracking and delivery confirmation.",
      "Our solution includes separate apps for customers, restaurant partners, and delivery executives — all synchronized through a powerful admin dashboard for complete operational control.",
      "Whether you're building a new food delivery startup or digitizing your existing restaurant chain, our platform delivers a seamless experience across web and mobile.",
    ],
    features: [
      "Customer Ordering App (Web & Mobile)",
      "Restaurant Partner Dashboard",
      "Delivery Driver App with GPS",
      "Real-Time Order Tracking",
    ...
    sections: [
      { heading: "Why Build a Food Delivery Platform?", body: "Online food ordering has become a necessity. Our platform helps restaurants increase revenue, reach more customers, and provide a branded digital experience without relying on third-party aggregators." },
      { heading: "Who Uses Food Delivery Software?", body: "Restaurants, cloud kitchens, food startups, catering businesses, grocery chains, and entrepreneurs looking to launch a food delivery marketplace in their city or region." },
    ],
    whoUses: ["Restaurants", "Cloud Kitchens", "Food Delivery Startups", "Catering Businesses", "Grocery Chains"],
    cta: "Launch Your Food Delivery Platform",
  },
};
